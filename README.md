...
## How to install it?
Install a nuget package into your Xamarin.Forms/Xamarin.Android projects:

`PM> Install-Package BluetoothClassic -Version 1.0`
...
3. Use `IBluetoothConnection: IDisposable` in a next way:
  ...
  * `event Recived OnRecived` to subscribe for reciving data from the connected remote device
